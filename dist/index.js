...
var ReactScrollDetect = function (props) {
    ...
    var _c = React.useState([]), sections = _c[0], setSections = _c[1];
...
var _ScrollContainer = function (props) {
    var _a = React.useContext(ReactScrollDetectContext), sections = _a.sections, onChange = _a.onChange, index = _a.index;
